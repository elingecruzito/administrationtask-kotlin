    ...
    fun loadData(query:String, selectionArgs: Array<String?>, context: Context){
        ...
        if(cursor.columnCount > 0){
            ...
            do {
                ...
                tasksModel?.task = cursor.getString(cursor.getColumnIndex(TaskEntry.COLUMN_NAME_TASK))
                ...
                tasksModel?.hour = cursor.getString(cursor.getColumnIndex(TaskEntry.COLUMN_NAME_HOUR))
                tasksModel?.date = cursor.getString(cursor.getColumnIndex(TaskEntry.COLUMN_NAME_DATE))
